...
1000 resamples, seed 42, two-sided, BH FDR α=0.05 across 17 tests.
...
| online-boutique: KG-effect (Hybrid vs no-graph) | 0.559 | 0.592 | -0.033 | [-0.076,+0.006] | 0.148 | 0.210 | · |
| otel-demo: Hybrid vs BiEncoder | 0.672 | 0.681 | -0.008 | [-0.076,+0.059] | 0.938 | 0.966 | · |
| otel-demo: Hybrid vs BM25(fair) | 0.672 | 0.597 | +0.076 | [+0.000,+0.160] | 0.064 | 0.099 | · |
| otel-demo: Hybrid vs BGE-dense | 0.672 | 0.664 | +0.008 | [-0.059,+0.076] | 0.942 | 0.966 | · |
| otel-demo: Hybrid vs KG | 0.672 | 0.412 | +0.261 | [+0.151,+0.370] | 0.000 | 0.000 | ✓ |
| otel-demo: Hybrid vs LLM-RAG | 0.672 | 0.639 | +0.034 | [-0.034,+0.101] | 0.444 | 0.581 | · |
| otel-demo: KG-effect (Hybrid vs no-graph) | 0.672 | 0.681 | -0.008 | [-0.059,+0.042] | 0.886 | 0.966 | · |
...
| wol-v3: Hybrid vs KG | 0.970 | 0.308 | +0.663 | [+0.650,+0.677] | 0.000 | 0.000 | ✓ |
| wol-v3: Hybrid vs LLM-RAG | 0.978 | 0.856 | +0.122 | [+0.094,+0.152] | 0.000 | 0.000 | ✓ |
| wol-v3: KG-effect (Hybrid vs no-graph) | 0.970 | 0.970 | -0.000 | [-0.003,+0.003] | 0.966 | 0.966 | · |
