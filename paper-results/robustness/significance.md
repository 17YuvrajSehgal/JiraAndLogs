...
1000 resamples, seed 42, two-sided, BH FDR α=0.05 across 16 tests.

| comparison | Hybrid Hit@5 | other | Δ | 95% CI | p | q(BH) | sig |
|---|---|---|---|---|---|---|---|
| online-boutique: Hybrid vs BiEncoder | 0.559 | 0.634 | -0.076 | [-0.136,-0.018] | 0.016 | 0.026 | ✓ |
...
| online-boutique: KG-effect (Hybrid vs no-graph) | 0.559 | 0.592 | -0.033 | [-0.076,+0.006] | 0.148 | 0.197 | · |
| otel-demo: Hybrid vs BiEncoder | 0.672 | 0.681 | -0.008 | [-0.076,+0.059] | 0.938 | 0.942 | · |
| otel-demo: Hybrid vs BM25(fair) | 0.672 | 0.597 | +0.076 | [+0.000,+0.160] | 0.064 | 0.093 | · |
...
| otel-demo: Hybrid vs LLM-RAG | 0.672 | 0.639 | +0.034 | [-0.034,+0.101] | 0.444 | 0.546 | · |
