...
ongoing incident. Faced with the \emph{same} symptom as a one-sentence text
ticket, the identical system profiles a text-only capability set, skips the
telemetry steps, and emits a lightweight dense-and-graph plan: graceful
degradation as a different path through one skill library.
