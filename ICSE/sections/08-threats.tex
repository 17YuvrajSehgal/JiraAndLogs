...
prevent any leakage of future or training information, though only the costly
real-data retriever is trained on a single seed (the two telemetry retrievers are
stable across three seeds, \S\ref{sec:results-rq1}), which we report rather than
overstate.
