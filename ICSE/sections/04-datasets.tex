...
activity, is the atomic input to the triage system.
...
The two applications differ in \emph{architecture}, not merely size, so a method cannot succeed by memorizing one system's quirks.
