...
of its parts, we report our fine-tuned dense bi-encoder and our knowledge-graph
retriever on their own, alongside the full hybrid that fuses them with a learned
sparse retriever.
...
precision--recall curve, the area under the ROC curve, and expected calibration
error. We also report, operationally, pages per
