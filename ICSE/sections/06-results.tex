...
synthetic systems. Page suppression works: across all three datasets the system emits about one page per incident, the mechanism firing $3{,}061$ times on the real corpus to fold repeat windows into the alert already raised rather than paging afresh for every window.
