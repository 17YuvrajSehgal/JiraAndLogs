...
saturated, it is where the gains we report come from.
...
\emph{what evidence is present} and \emph{whether an expensive step is
beneficial} as per-window, per-setting decisions, which lets one
